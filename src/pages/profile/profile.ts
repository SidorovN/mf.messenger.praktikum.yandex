...
import {tmpl as profileFormTmpl} from '../../blocks/profile/profileForm.tmpl';
import {tmpl as profileAsideTmpl} from '../../blocks/profile/profileAside.tmpl';
import {tmpl as profilePopupTmpl} from '../../blocks/profile/profilePopup.tmpl';
...
const avatarPopup = new Form(
    {
        ...
        onSubmit() {
            xhr.put(`${API_URL}user/profile/avatar`, {
                ...
                eventBus.emit('toggleAvatarPopup');
            });
        },
        emitChange() {}
    },
...
eventBus.on('logoutUser', () => {
    const xhr = new HTTPTransport();
    xhr.post(`${API_URL}auth/logout`).then(() => {
